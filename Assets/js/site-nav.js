/* ==================================================
   WebZoneBW SC
   Shared Site Navigation (static pages)
...
(function () {
  ...
  var FOOTER_HTML =
    ...
    '<span class="webzonebw-footer-brand-icon" aria-hidden="true">&#128218;</span>' +
    ...
    '<a href="https://webzonebw.in/" target="_blank" rel="noopener noreferrer" aria-label="Official Website">&#127760;</a>' +
    '<a href="mailto:enquiry@webzonebw.in" aria-label="Email Contact">&#128231;</a>' +
    '</div></div>' +
    ...
    '<span class="webzonebw-footer-divider">&middot;</span>' +
  ...
  function render() {
    ...
    mount.innerHTML =
      ...
      '<span class="webzonebw-brand-sub">Learn &middot; Build &middot; Ship</span></span></a>' +
      "</div>" +
      ...
      '<span class="webzonebw-theme-icon webzonebw-theme-moon" aria-hidden="true">&#127769;</span>' +
      '<span class="webzonebw-theme-icon webzonebw-theme-sun" aria-hidden="true">&#9728;&#65039;</span>' +
      "</button>" +
      "</div>" +
      "</div>" +
