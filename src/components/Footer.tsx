          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-1 text-xs text-app-muted">
              <li>
                <button
                  type="button"
                  onClick={() => onNavigateWebTools ? onNavigateWebTools() : (window.location.href = "/webtools.html")}
                  className="group flex min-h-[36px] w-full items-center justify-between py-1.5 hover:text-app-amber transition-colors text-left touch-manipulation cursor-pointer"
                >
                  <span className="flex items-center gap-2">
                    <Terminal className="h-3.5 w-3.5 text-app-subtle group-hover:text-app-amber" />
                    <span>Web Tools &amp; Validators</span>
                  </span>
              ...
              <li>
                <button
                  type="button"
                  onClick={() => onNavigateWorkspace ? onNavigateWorkspace() : (window.location.href = "/Workspace.html")}
                  className="group flex min-h-[36px] items-center gap-2 py-1.5 hover:text-app-amber transition-colors text-left touch-manipulation cursor-pointer"
                >
                  <Code2 className="h-3.5 w-3.5 text-app-subtle group-hover:text-app-amber" />
                  <span>Workspace Split Editor</span>
                </button>
              </li>
              <li>
                <button
                  type="button"
                  onClick={() => onNavigateImageTools ? onNavigateImageTools() : (window.location.href = "/imagetools.html")}
                  className="group flex min-h-[36px] items-center gap-2 py-1.5 hover:text-app-amber transition-colors text-left touch-manipulation cursor-pointer"
                >
                  <Box className="h-3.5 w-3.5 text-app-subtle group-hover:text-app-amber" />
                  <span>Image &amp; Visual Studio</span>
                </button>
              </li>
              <li>
                <button
                  type="button"
                  onClick={() => onNavigateDeveloperTools ? onNavigateDeveloperTools() : (window.location.href = "/developertools.html")}
                  className="group flex min-h-[36px] items-center gap-2 py-1.5 hover:text-app-amber transition-colors text-left touch-manipulation cursor-pointer"
                >
            ...
            <ul className="space-y-2 text-xs text-app-muted">
                ...
                return (
                  <li key={ch.id}>
                    <button
                      type="button"
                      onClick={() => {
                        if (onSelectLesson) onSelectLesson(firstLessonId);
                        else if (onNavigateLearn) onNavigateLearn();
                        else window.location.href = `/learn.html`;
                      }}
                      className="group flex min-h-[36px] items-center gap-1.5 py-1.5 hover:text-app-amber transition-colors text-left touch-manipulation cursor-pointer"
                    >
              ...
              {defaultChapters.length > 7 && (
                <li>
                  <button
                    type="button"
                    onClick={() => onNavigateLearn ? onNavigateLearn() : (window.location.href = "/learn.html")}
                    className="font-mono text-[11px] font-semibold text-app-amber hover:underline pt-1 min-h-[36px] inline-flex items-center gap-1 touch-manipulation cursor-pointer"
                  >
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-1 text-xs text-app-muted">
              ...
              <li>
                <button
                  type="button"
                  onClick={() => onNavigateBlog ? onNavigateBlog() : (window.location.href = "/blog.html")}
                  className="flex min-h-[36px] items-center gap-2 py-1.5 hover:text-app-amber transition-colors text-left touch-manipulation cursor-pointer"
                >
                  <FileText className="h-3.5 w-3.5 text-app-subtle" />
              ...
              <li>
                <button
                  type="button"
                  onClick={() => onNavigateAbout ? onNavigateAbout() : (window.location.href = "/about.html")}
                  className="flex min-h-[36px] items-center gap-2 py-1.5 hover:text-app-amber transition-colors text-left touch-manipulation cursor-pointer"
                >
                  <Compass className="h-3.5 w-3.5 text-app-subtle" />
                  <span>About WebZoneBW SC</span>
                </button>
              </li>
              <li>
                <button
