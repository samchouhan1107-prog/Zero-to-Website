        ...
        <nav aria-label="Curriculum Hubs" className="shrink-0 border-b border-app-border bg-app-surface p-2.5">
          <div className="grid grid-cols-2 gap-1.5">
            ...
            <button
              ...
              className={`flex items-center gap-2 rounded-lg px-2.5 py-2 text-left text-xs font-bold transition-all cursor-pointer ${
            ...
            >
              <Compass className={`h-4 w-4 shrink-0 ${activeView === 'learn' || activeView === 'curriculum' ? 'text-app-amber' : 'text-app-subtle'}`} />
