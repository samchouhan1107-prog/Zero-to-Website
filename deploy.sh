#!/bin/bash
# Webzonebw Storehouse Backend Deployment Script
# Deploys the Express API to Render.com via GitHub

echo "🚀 Webzonebw Storehouse Backend Deployment"
echo "================================"
echo ""
...
echo "4. Settings:"
echo "   - Name: webzonebw-storehouse-api"
echo "   - Runtime: Node"
echo "   - Build: npm run build"
echo "   - Start: node dist/server.cjs"
echo "5. Add environment variables:"
echo "   NODE_ENV=production"
echo "   CORS_ORIGIN=https://webzonebw-storehouse.shop"
echo "6. Click 'Create Web Service'"
echo ""
echo "7. Once deployed, get your API URL (e.g. https://webzonebw-storehouse-api.onrender.com)"
echo "8. Then rebuild frontend with:"
echo "   VITE_API_URL=https://webzonebw-storehouse-api.onrender.com/api npm run build"
